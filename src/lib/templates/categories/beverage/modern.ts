...
export function getBeverageModernTemplate(): string {
  const colors = getColorScheme('beverage', 'modern');
  return `<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8">
  ...
  <style>
    /* ===========================
       Beverage Modern Theme
       Cool Blue / Teal Accent
       =========================== */
    :root {
    ...
    .cta-button:hover {
      box-shadow: 0 15px 40px rgba(8,145,178,0.55);
    }
  ...
  <div class="detail-page">
    ...
    <section class="temp-section section">
      <div class="temp-content">
        ...
        <p class="body-md" style="margin-top:var(--space-2);">가장 맛있게 즐기는 온도를 알려드립니다</p>
    ...
    <section class="pairing-section section">
      <div style="text-align:center; margin-bottom:var(--space-2);">
        ...
        <p class="body-md" style="margin-top:var(--space-2);">전문가가 추천하는 궁합 음식</p>
      </div>
    ...
    <section class="season-section section">
      <div style="text-align:center; margin-bottom:var(--space-2);">
        ...
        <p class="body-md" style="margin-top:var(--space-2);">일상 속 최적의 순간</p>
      </div>
    ...
    <section class="nutrition-section section">
      <div style="text-align:center; margin-bottom:var(--space-2);">
        ...
        <p class="body-md" style="margin-top:var(--space-2);">한 병(1회 제공량) 기준</p>
      </div>
